...
def main():
  application = webapp.WSGIApplication(
                                       [('/', StartPage),
                                        ...
                                        ('/feeds', FeedsPage),
                                        ('/bytype', CategoryView),
                                        ('/bytype-pure', CategoryViewPure),
                                        ('/bytype-applied', CategoryViewApplied),
                                        ('/bytype-teacher', CategoryViewTeacher),
                                        ('/bytype-visual', CategoryViewVisual),
                                        ('/bytype-history', CategoryViewHistory),
                                        ('/bytype-art', CategoryViewArt),
                                        ('/bytype-fun', CategoryViewFun),
                                        ('/bytype-general', CategoryViewGeneral),
                                        ('/bytype-journalism', CategoryViewJournalism),
                                        ('/bytype-journals', CategoryViewJournals),
                                        ('/bytype-commercial', CategoryViewCommercial),
                                        ('/bytype-communities', CategoryViewCommunities),
                                        ('/bytype-institutions', CategoryViewInstitutions),
                                        ('/bytype-news', CategoryViewNews),
                                        ('/bytype-carnivals', CategoryViewCarnivals),
