...
#class TagListWorker(webapp.RequestHandler):
##    cacheName = "Global_Weighted_Taglist"
##    def write_list_to_datastore(self):
#        x = Stored_List()
##        x.content = self.generateList()
...
#        x.content = json.dump(weighted_taglist)
##    def get(self):
##        self.write_list_to_datastore()
#        x.put()
...
#class PlanetTag(TemplatePage):
    ...
    #def generateContent(self):
       ...
       #*/
       #var word_list = [ """ )
        #for tag_weight in json.loads(Stored_List.gql("WHERE name = 'Global_Weighted_Tasklist'").get()):
